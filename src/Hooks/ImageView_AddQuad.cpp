...
MAKE_AUTO_HOOK_ORIG_MATCH(ImageView_GenerateFilledSprite, &HMUI::ImageView::GenerateFilledSprite, void, HMUI::ImageView* ptr, UnityEngine::UI::VertexHelper vertexHelper, bool preserveAspect, float curvedUIRadius) {
    lastCurvedUIRadius = curvedUIRadius;
    ImageView_GenerateFilledSprite(ptr, vertexHelper, preserveAspect, curvedUIRadius);
}
...
MAKE_AUTO_HOOK_ORIG_MATCH(ImageView_AddQuad, static_cast<void (*)(UnityEngine::UI::VertexHelper, ArrayW<::UnityEngine::Vector3>, UnityEngine::Color32, ArrayW<::UnityEngine::Vector3>)>(&HMUI::ImageView::AddQuad), void, UnityEngine::UI::VertexHelper vertexHelper, ArrayW<UnityEngine::Vector3> quadPositions, UnityEngine::Color32 color, ArrayW<UnityEngine::Vector3> quadUVs) {
    ...
    for (int i = 0; i < 4; i++)
    {
        vertexHelper.AddVert(quadPositions[i], color, {quadUVs[i].x, quadUVs[i].y}, {0, 0}, uv, {0, 0}, {0, 0, 0}, {0, 0, 0, 0});
    }

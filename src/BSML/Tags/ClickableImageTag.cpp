...
namespace BSML {
    ...
    GlobalNamespace::Signal get_imageClickedSignal() {
        ...
        return GlobalNamespace::Signal(imageClickedSignal.ptr());
    }
    ...
    HapticPresetSO get_imageHapticPreset() {
        ...
        return HapticPresetSO(imageHapticPreset.ptr());
    }
    ...
    GlobalNamespace::HapticFeedbackController get_imageHapticFeedbackController() {
        ...
        return GlobalNamespace::HapticFeedbackController(imageHapticFeedbackController.ptr());
    }

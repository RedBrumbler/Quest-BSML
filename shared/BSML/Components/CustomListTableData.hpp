...
DECLARE_CLASS_CODEGEN_EXPORT(BSML, CustomCellInfo, System::Object,
...
DECLARE_CLASS_CODEGEN_INTERFACES_EXPORT(BSML, CustomListTableData, UnityEngine::MonoBehaviour, classof(HMUI::TableView::IDataSource*),

...
DECLARE_CLASS_CODEGEN(BSML, CustomCellTableCell, HMUI::TableCell,
    ...
    DECLARE_INSTANCE_FIELD(SListW<UnityEngine::GameObject*>, selectedTags);
    DECLARE_INSTANCE_FIELD(SListW<UnityEngine::GameObject*>, hoveredTags);
    DECLARE_INSTANCE_FIELD(SListW<UnityEngine::GameObject*>, neitherTags);

...
#ifdef ClickableText_Interfaces
#undef ClickableText_Interfaces
#endif

#define ClickableText_Interfaces {classof(UnityEngine::EventSystems::IPointerClickHandler*), classof(UnityEngine::EventSystems::IPointerEnterHandler*), classof(UnityEngine::EventSystems::IPointerExitHandler*), classof(UnityEngine::EventSystems::IEventSystemHandler*)}

___DECLARE_TYPE_WRAPPER_INHERITANCE(BSML, ClickableText, Il2CppTypeEnum::IL2CPP_TYPE_CLASS, HMUI::CurvedTextMeshPro, "BSML", ClickableText_Interfaces, 0, nullptr,

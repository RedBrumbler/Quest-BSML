...
DECLARE_CLASS_CORDL_INTERFACES(BSML, ClickableText, HMUI::CurvedTextMeshPro, std::vector<Il2CppClass*>({classof(UnityEngine::EventSystems::IPointerClickHandler), classof(UnityEngine::EventSystems::IPointerEnterHandler), classof(UnityEngine::EventSystems::IPointerExitHandler), classof(UnityEngine::EventSystems::IEventSystemHandler)}),
    DECLARE_FIELDS(
